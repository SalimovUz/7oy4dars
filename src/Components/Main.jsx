      ...
      <div className="container mx-auto">
        <main className="flex">
          ...
          <div>
            ...
            <div className="content flex flex-col gap-12 border-t-[2px] border-solid border-slate-400 py-16 px-12">
            ...
            <div className="content w-full flex py-6  p-2">
              ...
              <div className="flex flex-col gap-8 justify-end w-1/2 pt-32">
                <h2 className="text-2xl text-rose-950 font-semibold">
            ...
            <div className="content w-full py-10 flex border-t-[2px] border-solid border-slate-400 px-8">
              <div className="left w-1/2">
                <h1 className="text-2xl text-rose-950 font-semibold">
                  Expertise
                </h1>
              </div>
